...
const reviews = [
  { reviewer: "Ada",     rating: 5, comment: "Changed how I think about writing code.",   bookId: 1 },
  { reviewer: "Marcus",  rating: 4, comment: "Dense but worth it. Re-read every year.",   bookId: 1 },
  { reviewer: "Sofia",   rating: 5, comment: "One of the most honest memoirs I've read.", bookId: 2 },
  { reviewer: "James",   rating: 5, comment: "A classic. Every sci-fi fan should read it.", bookId: 3 },
  { reviewer: "Priya",   rating: 4, comment: "Took a few chapters to get into, then couldn't stop.", bookId: 3 },
  { reviewer: "Carlos",  rating: 3, comment: "Interesting but a bit long.",               bookId: 4 },
  { reviewer: "Amara",   rating: 5, comment: "Short and profound. Read it in one sitting.", bookId: 5 },
];
